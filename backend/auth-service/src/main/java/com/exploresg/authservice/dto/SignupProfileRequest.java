...
public class SignupProfileRequest {
         ...
         */
        @Pattern(regexp = "^[a-z]{2}(-[A-Z]{2})?$", message = "Invalid language code format (use ISO 639-1)")
         ...
         */
        @Pattern(regexp = "^[A-Z]{2}$", message = "Invalid country code format (use ISO 3166-1 alpha-2)")
